  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 transition-transform"
      >
        ...
        <div className="fixed bottom-36 right-6 z-50 w-80 rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden">
          ...
          <div className="px-5 pb-5">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full rounded-xl bg-[#25D366] py-3 text-white font-bold text-sm hover:bg-[#20bd5a] transition-colors"
            >
