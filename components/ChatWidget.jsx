  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#D7FF4D] text-slate-900 shadow-lg hover:scale-105 transition-transform"
      >
      ...
      {open && (
        <div className="fixed bottom-36 right-6 z-50 w-80 rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden">
          {/* Header */}
          <div className="bg-[#D7FF4D] px-5 py-4 flex items-center gap-3">
          ...
          <div className="px-5 pb-5">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full rounded-xl bg-[#D7FF4D] py-3 text-slate-900 font-bold text-sm hover:bg-[#b8d943] transition-colors"
            >
