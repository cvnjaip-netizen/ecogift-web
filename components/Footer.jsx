    ...
    <footer className="border-t border-slate-200 bg-white">
      <Container>
        <div className="grid md:grid-cols-3 gap-12 py-12">
          {/* Brand Column */}
          <div>
            <h3 className="text-xl font-bold text-eco-ink mb-3">EcoGift Chile</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="text-eco-ink/70">Santiago, Chile</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 pt-8 mt-8">
          <p className="text-center text-sm text-eco-ink/60">
            © 2026 EcoGift Chile. Todos los derechos reservados.
          </p>
        </div>
      </Container>
    </footer>
